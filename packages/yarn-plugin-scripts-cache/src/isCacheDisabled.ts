...
export function isCacheDisabled(config: Config) {
    return isDisabled(config, DISABLED_ENVIRONMENT_VARIABLE_NAME, "cacheDisabled")
}

export function isCacheReadDisabled(config: Config) {
    return isDisabled(config, READ_DISABLED_ENVIRONMENT_VARIABLE_NAME, "cacheReadDisabled")
}

export function isCacheWriteDisabled(config: Config) {
    return isDisabled(config, WRITE_DISABLED_ENVIRONMENT_VARIABLE_NAME, "cacheWriteDisabled")
}

function isDisabled(config: Config, environmentVariableName: string, configFieldName: keyof Pick<Config, "cacheDisabled" | "cacheReadDisabled" | "cacheWriteDisabled">) {
